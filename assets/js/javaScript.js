...
$(document).ready(function () {
    var characters = {
        "Naruto Uzumaki": {
            ...
            health: 120,
            attack: 12,
            imageUrl: "assets/images/ninja/naruto.jpeg",
            enemyAttackBack: 15
        },
        "Sasuke Uchiha": {
            name: "Sasuke Uchiha",
            health: 100,
            attack: 13,
            imageUrl: "assets/images/ninja/sasuke.jpeg",
            enemyAttackBack: 10
        },
        "Sakura Haruno": {
            name: "Sakura Haruno",
            health: 50,
            attack: 5,
            imageUrl: "assets/images/ninja/sakura.jpeg",
            enemyAttackBack: 5
        },
        "Kakashi Hatake": {
            name: "Kakashi Hatake",
            health: 175,
            attack: 20,
            imageUrl: "assets/images/ninja/kakashi.jpeg",
            enemyAttackBack: 20
        },
        "Madara Uchiha": {
            name: "Madara Uchiha",
            health: 180,
            attack: 25,
            imageUrl: "assets/images/ninja/madara.jpg",
            enemyAttackBack: 25
        }
    };
    var attacker;
    ...
    $("#attack-button").on("click", function () {
        if ($("defender").children().length === 0) {
            ...
            clearMessage();
            renderMessage("There is no enemy here");
        }
    });
});